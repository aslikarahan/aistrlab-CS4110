...
public class Problem1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // main i/o-loop
        while (true) {
            String input = nl.tudelft.instrumentation.fuzzing.DistanceTracker.fuzz(eca.inputs);
            if (input.equals("R")) {
                eca = new Problem1();
                continue;
            }
            nl.tudelft.instrumentation.fuzzing.DistanceTracker.myIf(nl.tudelft.instrumentation.fuzzing.DistanceTracker.binaryExpr(nl.tudelft.instrumentation.fuzzing.DistanceTracker.binaryExpr(nl.tudelft.instrumentation.fuzzing.DistanceTracker.binaryExpr(nl.tudelft.instrumentation.fuzzing.DistanceTracker.binaryExpr(nl.tudelft.instrumentation.fuzzing.DistanceTracker.binaryExpr(nl.tudelft.instrumentation.fuzzing.DistanceTracker.binaryExpr(nl.tudelft.instrumentation.fuzzing.DistanceTracker.binaryExpr(nl.tudelft.instrumentation.fuzzing.DistanceTracker.binaryExpr(nl.tudelft.instrumentation.fuzzing.DistanceTracker.binaryExpr(nl.tudelft.instrumentation.fuzzing.DistanceTracker.equals(nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar("iA"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar(input)), nl.tudelft.instrumentation.fuzzing.DistanceTracker.equals(nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar("iB"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar(input)), "&&"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.equals(nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar("iC"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar(input)), "&&"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.equals(nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar("iD"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar(input)), "&&"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.equals(nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar("iE"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar(input)), "&&"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.equals(nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar("iF"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar(input)), "&&"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.equals(nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar("iG"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar(input)), "&&"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.equals(nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar("iH"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar(input)), "&&"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.equals(nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar("iI"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar(input)), "&&"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.equals(nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar("iJ"), nl.tudelft.instrumentation.fuzzing.DistanceTracker.MyVar(input)), "&&"), (input.equals("iA")) && (input.equals("iB")) && (input.equals("iC")) && (input.equals("iD")) && (input.equals("iE")) && (input.equals("iF")) && (input.equals("iG")) && (input.equals("iH")) && (input.equals("iI")) && (input.equals("iJ")), 1873);
